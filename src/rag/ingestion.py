...
CLI:  python -m src.rag.ingestion AAPL
"""
...
from src.rag.chunking import ChunkRecord, chunk_section
from src.rag.embeddings import embed_passages, embedding_dim
from src.rag.parsing import parse_filing
from src.tools.edgar import CompanyIdentity, EdgarClient
...
def is_company_indexed(ticker: str) -> bool:
    """True if the vector store already holds chunks for this ticker."""
