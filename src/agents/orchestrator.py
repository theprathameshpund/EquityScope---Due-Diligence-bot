...
CLI:  python -m src.agents.orchestrator AAPL "competition risk"
...
import src.report.schema  # noqa: F401  (finalizes AgentState forward refs)
from src.agents.analyst_agent import analyst_node
from src.agents.critic_agent import critic_node
from src.agents.filings_agent import filings_node
...
from src.llm.router import get_tracker
from src.logging_setup import bind_run_id, get_logger
from src.memory.checkpoints import get_checkpointer
