...
import pytest
from app.llm.router import LLMResponse, LLMRouter, drop_tracker
from app.report.schema import DDReport
from app.state import AgentState, MarketSnapshot, NewsItem, RetrievedEvidence, RunBudget
from app.tools.edgar import CompanyIdentity
...
def patched_graph(monkeypatch: pytest.MonkeyPatch) -> Any:
    import app.agents.analyst_agent as analyst_mod
    import app.agents.critic_agent as critic_mod
    import app.agents.filings_agent as filings_mod
    import app.agents.market_agent as market_mod
